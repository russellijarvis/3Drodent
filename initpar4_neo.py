...
#The lines below replicate a particular error.
#/usr/local/lib/python2.7/dist-packages/9ML-0.3dev-py2.7.egg/nineml/abstraction_layer/dynamics/readers/xml_reader.pyc in _load_nested_xml(cls, filename, xml_node_filename_map)
#    335 
#    336         root = doc.getroot()
#--> 337         if root.nsmap[None] != nineml_namespace:
#    338             errmsg = ("The XML namespace is not compatible with this ve#rsion "
#    339                       "of the NineML library. Expected {}, file contain#s {}")

import nineml.abstraction_layer as al
al.readers.xml_reader.XMLReader.read('HodgkinHuxley.xml')


c = al.ComponentClass('arbitary_label')
al.writers.XMLWriter(c,"test.xml")
#al.readers.XMLReader.read("test.xml")

os.chdir('/home/russell/nineml/catalog/neurons')
al.readers.XMLReader.read("hhid19.xml")
 al.readers.XMLReader.read("multi_compartment.xml")
