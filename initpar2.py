...
NFILE = 150#3175#1175 # Maximum on this machine.
...
#h.cells=mb(RANK, NCELL, SIZE, allrows2, gidvec,h)
...
# This is a good use of gather.

ie0 = gather(ie0)
ie1 = gather(ie1)
#ieX is already 2 column. Zipping them togethor would create 4 columns.
ie = zip(ie0, ie1)

# ie=COMM.gather(ie,root=0)
...
allmemb=[]
if RANK==0:
    for fname in sorted(glob.glob('*soma*.dat_')):
        z = np.loadtxt(fname)
        allmemb.append(z)
