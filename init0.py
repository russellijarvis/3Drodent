...
h("plastic=0")
h("ncell=60")#minimum 17
#can take 100 now.
h("minr=0.001")
h("minrs=minr")
#I think executing the statement that spreads the cells out, is a big encumbent to establishing connection density.
#Instead, just find that statement and comment it out.
h("prunenet=0")
h("offset=0")
h("parallels=0")
...
h("lpy=0")
#lpy stands for launch from python
#the value of this variable is not important. The existence of the variable at all just means the program was launched from python. This allows for quick and convenient launching and initialising from HOC as an alternative.
